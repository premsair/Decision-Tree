...
def gain(attributes, data, targetAttr, attr, acctype):
    ...
    for val in valFreq.keys():
        ...
        subsetEntropy += valProb * entropy(attributes, dataSubset, targetAttr, acctype)
...
def chisquaretest(data,attributes,target,best,recursion):
    ...
    for val in values:
        ...
        expectp= (valFreqtotal*(rootvalFreq.get('+',0)))/no_of_rootrecords
        expectn= (valFreqtotal*(rootvalFreq.get('-',0)))/no_of_rootrecords
